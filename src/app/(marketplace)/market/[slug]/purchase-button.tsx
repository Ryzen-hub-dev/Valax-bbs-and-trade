  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <span>{isPurchasing ? "处理中..." : `立即使用 ${tokenPrice} Credits 兑换授权`}</span>
      </button>
      <p className="text-[11px] text-center text-slate-500 leading-tight">
        购买后将自动生成独占授权 License Key，并跳转官方验证 Release 交付。
      </p>
    </div>
  );
}